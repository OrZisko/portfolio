...
const sites = [
    {
        ...
        github: ['https://github.com/Noamzil/AudioFly', 'https://github.com/OrZisko/audioFly-backend'],
        imgName: 'audiofly',
        desc: 'This app, in the inspiration of spotify, allows you not only to search your favorite songs, create and organize your own playlists out of them, and listen and follow other people\'s playlists. But also allows a shared listening. The App is supported by a full Back-end, which in it\'s own makes use of a mongoDB database. The project was the finale project in a Full-Stack course, and was done by Noam Zilberman, Elior Papo and myself',
        uses: {
            frameworks: ['Vue.js'],
    ...
    },
    {
        name: 'Portfolio',
        id: 'portfolio',
        ip: 'https://orzisko.github.io/portfolio/',
        github: ['https://github.com/OrZisko/portfolio/tree/master'],
        imgName: 'portfolio',
        // desc: 'My first interaction with the Angular framework. The app is designed to simulate an account that holds money and shows it in the currency of dollars and bitcoins. And allows an exchange of money between list of friends',
        desc: 'The site you\'re in right now, serves as a portal to all my relevent information, my applications and also links to my media social activity.',
        uses: {
            frameworks: ['React.js'],
            style: 'Sass',
        }
